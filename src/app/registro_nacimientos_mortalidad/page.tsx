...
import { ComboboxAnimal } from "@/components/ui/comboboxAnimal"
...
export default function RegistroAnimalesTabs() {
    ...
    React.useEffect(() => {
        const fetchAnimales = async () => {
            ...
            if (animalesData) {
                setMadres(animalesData)
                setAnimalesVivos(animalesData.filter(a => a.estado_salud !== "Muerto"))
            }
        }
        fetchAnimales()
    }, [])
